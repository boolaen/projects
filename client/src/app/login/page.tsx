...
import { Tv, Mail, Lock, ArrowRight, Loader2, Eye, EyeOff } from "lucide-react";
                ...
                <div className="relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-black/70 p-8 shadow-2xl backdrop-blur-md sm:p-12">
                    ...
                    <div className="flex flex-col items-center gap-4 mb-10">
                        ...
                        <div className="text-center space-y-1 mt-2">
                            ...
                            <p className="text-sm font-medium text-zinc-400">Tekrar hoş geldiniz, maceraya devam edin.</p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2 pb-2">
                            <div className="flex justify-between items-center ml-1">
                                ...
                                <Link href="/forgot-password" className="text-xs font-semibold text-red-400 hover:text-red-300 transition-colors">Şifremi Unuttum?</Link>
                            </div>
                            <div className="relative group">
                    ...
                    <div className="mt-10 flex flex-col items-center justify-center gap-2 text-sm text-zinc-400">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Link href="/register" className="font-bold text-white hover:text-red-400 hover:underline underline-offset-4 transition-all">
                                Hemen Kayıt Ol
                            </Link>
                        </div>
                    </div>
